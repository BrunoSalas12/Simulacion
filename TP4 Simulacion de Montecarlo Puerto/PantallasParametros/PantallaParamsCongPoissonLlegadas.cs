...
{
    public partial class PantallaParamsCongPoissonLlegadas : Form
    {

        TP4MontecarloPuerto _pant;
        public PantallaParamsCongPoissonLlegadas(TP4MontecarloPuerto pant)
        {
            InitializeComponent();
            _pant = pant;
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    _pant.guardarParametrosCongPoisson(parametros);
                    _pant.Enabled = true;
                    this.Close();
                }
            }
