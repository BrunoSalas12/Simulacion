...
{
    public partial class PantallaParamsCongLlegadas : Form
    {
        TP4MontecarloPuerto _pant;
        public PantallaParamsCongLlegadas(TP4MontecarloPuerto pant)
        {
            InitializeComponent();
            _pant = pant;
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    _pant.guardarParametrosCongLlegadas(parametros);
                    _pant.Enabled = true;
                    this.Close();
                }
            }
