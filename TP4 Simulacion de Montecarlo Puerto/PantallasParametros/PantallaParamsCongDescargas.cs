...
{
    public partial class PantallaParamsCongDescargas : Form
    {
        TP4MontecarloPuerto _pant;
        public PantallaParamsCongDescargas(TP4MontecarloPuerto pant)
        {
            InitializeComponent();
            _pant = pant;
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    _pant.guardarParametrosCongDescargas(parametros);
                    _pant.Enabled = true;
                    this.Close();
                }
            }
