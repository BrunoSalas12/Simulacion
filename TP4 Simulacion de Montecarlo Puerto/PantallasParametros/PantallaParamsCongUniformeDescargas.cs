...
{
    public partial class PantallaParamsCongUniformeDescargas : Form
    {
        TP4MontecarloPuerto _pant;
        public PantallaParamsCongUniformeDescargas(TP4MontecarloPuerto pant)
        {
            InitializeComponent();
            _pant = pant;
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    _pant.guardarParametrosCongUniforme(parametros);
                    _pant.Enabled = true;
                    this.Close();
                }
            }
